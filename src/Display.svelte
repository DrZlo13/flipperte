...
<script>
  ...
  export let bw_filled_color = { r: 255, g: 255, b: 255 };
  export let bw_empty_color = { r: 0, g: 0, b: 0 };
  ...
  export function colorRGB(red, green, blue) {
    ...
    switch (pixelFormat) {
      ...
      case pixelFormatEnum.bw:
        ...
        if (red + green + blue > 400) {
          red = bw_filled_color.r;
          green = bw_filled_color.g;
          blue = bw_filled_color.b;
        } else {
          red = bw_empty_color.r;
          green = bw_empty_color.g;
          blue = bw_empty_color.b;
        }
        break;
    ...
    let color = { r: red / 255.0, g: green / 255.0, b: blue / 255.0 };
    return color;
  }
